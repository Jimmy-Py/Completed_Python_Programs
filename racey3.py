# 5-3-20 A Bit Racey
# 5-10-20 Version 2, making the space bar both pause and un-pause.
# 5-13-20 Version 3, Adding Sound Effects
...
def paused():
    ...
    while pause:
        ...
        TextSurf, TextRect = text_objects("Paused: press space to Un-Pause", largeText)
...
def game_loop():
    ...
    while not gameExit:
        ...
        thing_start_Y += thing_speed  # moves thing down screen
        car(x, y)
        ...
        if thing_start_Y > display_height:
            ...
            thing_start_X = random.randrange(0, int(display_width - thing_width))
            dodged += 1
            #thing_speed += 1
